Public Class Bar
    ...
    Public Sub LoadGrid()
        SQL.Executar("SELECT f.designacao, b.id_bar, b.nome_bar, b.dia_bar, b.total_gasto_bar, b.total_recebido_bar, b.lucro_bar FROM Filial as f, Filial_Dia_Bar as b WHERE b.id_filial = f.id_filial and b.id_bar like '%" & txtBar.Text & "%' and b.dia_bar like '%" & txtDia.Text & "%'")

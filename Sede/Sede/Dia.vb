Public Class Dia
    ...
    Public Sub LoadGrid()
        SQL.Executar("SELECT f.designacao, d.dia, d.total_gasto, d.total_recebido, d.lucro FROM Filial as f, Filial_Dia as d WHERE d.id_filial = f.id_filial and d.dia like '%" & txtDia.Text & "%'")
